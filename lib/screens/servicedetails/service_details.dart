...
class _ServiceDetailsState extends State<ServiceDetails>
  ...
  Future<List<dynamic>> getServiceSubCategories(serviceId) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? authorizationToken = prefs.getString("auth_token");
    final response = await http.get(
      // Uri.parse(
                            ...
                            ? GestureDetector(
                                onTap: () async {
                                  ...
                                  var test = arguments[7]
                                      ? favouritesServiceIdMapper[arguments[8]]
                                      : favouritesServiceIdMapper[
                                          arguments[10]];
                                ...
                                onTap: () async {
                                  ...
                                  if (response.statusCode >= 200 &&
                                    ...
                                    ScaffoldMessenger.of(context)
                                        .showSnackBar(const SnackBar(
                                      content:
                                          Text("Service Added to favorites"),
                                      backgroundColor: kPrimaryColor,
                                      padding: EdgeInsets.all(25),
                                    ));
                                  } else {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(children: [
                        FutureBuilder<List<dynamic>>(
                          future: getServiceSubCategories(arguments[8]),
                          builder: (context, snapshot) {
                            //print(arguments);
